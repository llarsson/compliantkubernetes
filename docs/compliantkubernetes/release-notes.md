...
- Kubespray updated, including a new Kubernetes version upgrade to version <a href="https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.21.md#v1216">1.21.6</a>. This patch is mostly minor fixes, among them a fix to a bug in Kubespray when using username and password instead of application credentials to authenticate on Openstack platforms.

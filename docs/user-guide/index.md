...
* As a Continuous Delivery (CD) pipeline, I want to push changes to the Compliant Kubernetes environment, so that the new version of the application is running.

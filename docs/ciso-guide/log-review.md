...
1. Open up a browser and open the Compliant Kubernetes [logs](/user-guide/logs/) of the environment you are reviewing. This functionality is currently offered by Kibana and Elasticsearch.
